    ...
    public void updateDoctorProfile(DoctorDTO doctorDTO) {
        ...
        if (optionalDoctor.isPresent()) {
            ...
            if (doctorDTO.getLastName() == null || doctorDTO.getLastName().isBlank()) {
                throw new RuntimeException("Họ bác sĩ không được để trống");
            }
            if (doctorDTO.getField() == null || doctorDTO.getField().isBlank()) {
                throw new RuntimeException("Chuyên khoa không được để trống");
            }
