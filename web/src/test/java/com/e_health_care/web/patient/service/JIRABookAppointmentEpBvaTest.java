...
@Feature("Appointment Booking - EP/BVA")
class JIRABookAppointmentEpBvaTest extends BaseServiceTest {
    ...
    @Story("Đặt lịch hẹn với tất cả tham số hợp lệ")
    @Severity(SeverityLevel.BLOCKER)
    @Description("Kiểm tra hệ thống tạo thành công Appointment ở trạng thái PENDING khi patientId, doctorId, scheduleTime đều hợp lệ và bác sĩ đang rảnh.")
    ...
    @Story("Đặt lịch hẹn với patientId không tồn tại")
    @Severity(SeverityLevel.CRITICAL)
    @Description("Kiểm tra hệ thống ném lỗi 'Patient not found' khi patientId truyền vào không tồn tại trong cơ sở dữ liệu.")
    ...
    @Severity(SeverityLevel.CRITICAL)
    @Description("Kiểm tra hệ thống ném lỗi 'Doctor not found' khi doctorId truyền vào không tồn tại trong cơ sở dữ liệu.")
    ...
    @Story("Đặt lịch hẹn với thời gian trong quá khứ (biên now()-1s)")
    @Severity(SeverityLevel.NORMAL)
    @Description("Kiểm tra hệ thống ném lỗi khi scheduleTime nằm trong quá khứ, cụ thể tại biên now()-1 giây.")
    ...
    @Story("Đặt lịch hẹn với thời gian sát biên hiện tại")
    @Severity(SeverityLevel.MINOR)
    @Description("Kiểm tra hệ thống ném lỗi khi scheduleTime nằm ngay sát trước thời điểm hiện tại (boundary gần now()).")
    ...
    @Story("Đặt lịch hẹn tại biên tương lai gần nhất")
    @Severity(SeverityLevel.NORMAL)
    @Description("Kiểm tra hệ thống chấp nhận đặt lịch hẹn thành công khi scheduleTime chỉ vừa mới ở tương lai (now()+2s).")
    ...
    @Story("Đặt lịch hẹn khi bác sĩ đã kẹt lịch")
    @Severity(SeverityLevel.CRITICAL)
    @Description("Kiểm tra hệ thống ném lỗi 'Doctor is not available at this time' khi bác sĩ đã có lịch hẹn khác trùng khung giờ.")
    ...
    @Story("Đặt lịch hẹn xa trong tương lai")
    @Severity(SeverityLevel.MINOR)
    @Description("Kiểm tra hệ thống chấp nhận đặt lịch hẹn thành công khi scheduleTime cách hiện tại 30 ngày (biên nghiệp vụ xa).")
    ...
    @Story("Đặt lịch hẹn với nhiều tham số cùng sai")
    @Severity(SeverityLevel.MINOR)
    @Description("Kiểm tra thứ tự kiểm tra điều kiện của hệ thống: khi patientId, doctorId và scheduleTime đều sai cùng lúc, chỉ lỗi 'Patient not found' được ném ra do được kiểm tra trước.")
    ...
    @Story("Xem danh sách lịch hẹn theo bệnh nhân")
    @Severity(SeverityLevel.NORMAL)
    @Description("Kiểm tra hệ thống trả về đúng danh sách lịch hẹn khi truy vấn theo patientId.")
    ...
    @Story("Xem danh sách lịch hẹn theo bác sĩ")
    @Severity(SeverityLevel.NORMAL)
    @Description("Kiểm tra hệ thống trả về đúng danh sách lịch hẹn khi truy vấn theo doctorId.")
    ...
    @Story("Xem toàn bộ danh sách lịch hẹn")
    @Severity(SeverityLevel.MINOR)
    @Description("Kiểm tra hệ thống trả về đầy đủ danh sách toàn bộ lịch hẹn trong hệ thống.")
