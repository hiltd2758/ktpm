...
Scenario(
'Đặt lịch thành công với bác sĩ và thời gian hợp lệ',
...
Scenario(
'Validation khi chưa chọn bác sĩ',
...
BookAppointmentPage.fillDateTime(
futureDateTime()
);
...
Scenario(
'Validation khi chưa chọn thời gian',
